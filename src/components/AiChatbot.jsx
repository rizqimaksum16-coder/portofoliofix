...
export default function AiChatbot() {
  ...
  const knowledgeBase = [
    ...
    {
      keywords: ['vendora', 'repo vendora', 'github vendora', 'repository vendora'],
      answer: 'Repository GitHub untuk Vendora E-Commerce Platform dapat diakses di github.com/rizqimaksum16-coder/Vendora-web-project (Live Demo: vendora-backend-three.vercel.app).'
    },
    {
